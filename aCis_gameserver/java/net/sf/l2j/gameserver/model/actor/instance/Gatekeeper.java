...
public final class Gatekeeper extends Folk
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		if (command.startsWith("goto"))
		{
			...
			final TownZone zone = ZoneManager.getInstance().getZone(list.getX(), list.getY(), list.getZ(), TownZone.class);
			if (zone != null)
			{
				final Castle castle = CastleManager.getInstance().getCastleById(zone.getCastleId());
